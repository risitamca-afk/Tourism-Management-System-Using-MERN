...
const EmailVerificationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/landing");
      toast.success("Email Verificaton Successfull");
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    ...
    >
      ...
      {/* <motion.div
        ...
        className="max-w-md w-full bg-green-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden" */}
      {/* > */}
      {/* <div className="max-w-md w-full bg-white bg-opacity-20  backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden"> */}
      <motion.div
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="bg-white bg-opacity-20  backdrop-filter backdrop-blur-xl rounded-2xl shadow-2xl p-8 w-full max-w-md"
      >
