...
const ForgotPasswordPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="p-8">
          <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r bg-white text-transparent bg-clip-text">
            Forgot Password
          </h2>
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit}>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-lg shadow-lg hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200"
                type="submit"
              >
                {isLoading ? (
